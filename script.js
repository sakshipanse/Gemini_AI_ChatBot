...
const handleFormSubmit = (e) => {
    ...
    if(!userMessage || document.body.classList.contains("bot-responsing"))return;

    promptInput.value = "";
    userData.message = userMessage;
    document.body.classList.add("bot-responsing", "chats-active");
...
document.querySelector("#delete-chats-btn").addEventListener("click", () => {
    ...
    document.body.classList.remove("bot-responsing", "chats-active");
});
...
document.addEventListener("click", ({ target }) => {
    ...
    wrapper.classList.toggle("hide-contols", shouldHide);
});
...
// Set initial theme from loacal storage
